...
import { HiChartPie, HiCog, HiSearch, HiViewGrid, HiCube, HiDocumentReport, HiCubeTransparent, HiViewBoards } from "react-icons/hi";
...
const ExampleSidebar: FC = function () {
  ...
  const [isStokAlatOpen, setStokAlatOpen] = useState(true);
  const [isRekapanOpen, setRekapanOpen] = useState(true);
  ...
  useEffect(() => {
    ...
    setStokAlatOpen(
      newPage.includes("/services/first-one") ||
      newPage.includes("/services/add-harga") ||
      newPage.includes("/services/company-cleanup")
    );
    setRekapanOpen(newPage.includes("/services/generate-rekapan"));
    setServicesOpen(
      newPage.includes("/services/bikin-tagihan") ||
      newPage.includes("/services/all-in-one")
    );
    setAnalyticsOpen(newPage.includes("/services/dashboard-elements"));
  }, []);
          ...
          <div>
            ...
            <Sidebar.Items>
              <Sidebar.ItemGroup>
                ...
                <Sidebar.Collapse
                  icon={HiCube}
                  label={t.sidebar.stokAlat}
                  open={isStokAlatOpen}
                >
                  <Sidebar.Item
                    href={Urls.FIRST_SERVICE}
                    className={
                      Urls.FIRST_SERVICE === currentPage
                  ...
                  <Sidebar.Item
                    href={Urls.COMPANY_CLEANUP}
                    className={
                      Urls.COMPANY_CLEANUP === currentPage
                        ? "bg-gray-100 dark:bg-gray-700"
                        : ""
                    }
                  >
                ...
                <Sidebar.Collapse
                  ...
                  label={t.sidebar.rekapan}
                  open={isRekapanOpen}
                >
                  <Sidebar.Item
                    href={Urls.GENERATE_REKAPAN}
                    className={
                      Urls.GENERATE_REKAPAN === currentPage
                        ? "bg-gray-100 dark:bg-gray-700"
                        : ""
                    }
                  >
                ...
                <Sidebar.Collapse
                  ...
                  label={t.sidebar.additionalServices}
                  open={isServicesOpen}
                >
                  <Sidebar.Item
                    href={Urls.BIKIN_TAGIHAN}
                    className={
                      Urls.BIKIN_TAGIHAN === currentPage
                        ? "bg-gray-100 dark:bg-gray-700"
                        : ""
                    }
                  >
                    {t.sidebar.bikinTagihan}
                  </Sidebar.Item>
                  <Sidebar.Item
                    href={Urls.ALL_IN_ONE}
                    className={
                      Urls.ALL_IN_ONE === currentPage
                        ? "bg-gray-100 dark:bg-gray-700"
                        : ""
                    }
                  >
                ...
                >
                  <Sidebar.Item
                    href={Urls.DASHBOARD_ELEMENTS}
                    className={
                      Urls.DASHBOARD_ELEMENTS === currentPage
                        ? "bg-gray-100 dark:bg-gray-700"
                        : ""
                    }
                  >
                    {t.sidebar.dashboardElements}
                  </Sidebar.Item>
                </Sidebar.Collapse>
              </Sidebar.ItemGroup>
            </Sidebar.Items>
