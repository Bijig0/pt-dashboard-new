        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center">
            ...
            <Navbar.Brand href="/">
              <img
                alt=""
                src="https://www.brady-surya.com/assets/images/SwiftQuLogo.png"
...
const UserDropdown: FC = function () {
  ...
  return (
    ...
    >
      <Dropdown.Header>
        <span className="block text-sm">PT Pro Alat Admin</span>
...
const RestartOnboardingButton: FC = function () {
  ...
  return (
    ...
    >
      <span className="sr-only">Restart Onboarding</span>
