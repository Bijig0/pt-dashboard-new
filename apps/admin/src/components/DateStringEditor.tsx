import { parseDateYYYYMMDD } from "#src/utils/parseDateYYYY-MM-DD/parseDateYYYYMMDD.js";
import {
  forwardRef,
  memo,
  useEffect,
...
export type DateStringEditorParams = {
  nextMonthDate: string;
};

type Props = {
  params: DateStringEditorParams;
};

const DateStringEditor = memo(
  forwardRef((props: Props, ref) => {
    const createInitialState = () => {
      ...
      if (eventKey === KEY_BACKSPACE) {
        ...
        console.log("Running");
        startValue = props.params.nextMonthDate;
    ...
    useImperativeHandle(ref, () => {
      return {
        ...
        getValue() {
          // value is in dd-mm-yyyy format I think
          const parsedDate = parseDateYYYYMMDD(value);
          const reformattedDate = parsedDate.format("DD/MM/YYYY");
