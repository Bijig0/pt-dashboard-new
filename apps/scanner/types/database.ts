/**
 * Database types from pt-dashboard Supabase
 * Generated from pt-dashboard-admin/src/types/supabase.ts
 */
...
export type Alat = Tables<'alat'>;
export type AlatInsert = TablesInsert<'alat'>;
export type Company = Tables<'company'>;
export type CompanyInsert = TablesInsert<'company'>;
export type DbRecord = Tables<'record'>;
export type RecordInsert = TablesInsert<'record'>;
export type Stok = Tables<'stok'>;
export type StokInsert = TablesInsert<'stok'>;
